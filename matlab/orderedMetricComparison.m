function orderedMetricComparison(netType, mode, metric1, metric2)
    ...
    h = figure;
    [xtitle, ytitle, plotTitle] = getTitle(metricIndexA,metricIndexB);
    plotTitle = strcat(plotTitle, '-', mode);
    c = colormap(jet);
    for k =1:6
        subplot(3,2,k);
        [x,y] = getComparisonData(cuisines{k}, netType, metricIndexA, metricIndexB);
