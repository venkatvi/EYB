!function(){
	...
	bP.partData = function(data,p){
		var sData={};
		sData.keys=[
			d3.set(data.map(function(d){ return d.slice(0,2).join(',');})).values().sort(function(a,b){ console.log(a); console.log(b);}),
			d3.set(data.map(function(d){ var tempD=d.join(','); return tempD.slice(2,4);})).values().sort(function(a,b){ a1=a.split(',')[1]; b1=b.split(',')[1]; return ( a1-b1);})
		];
